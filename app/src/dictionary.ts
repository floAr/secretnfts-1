...
export const dictionary: dictionary = {
  ...
  SUBSCRIBE_TEXT: {
    en: `Subscribe to the newsletter to hear about Secret NFTs updates and
        events.`,
    pt: '',
  },
  ...
  FOOTER_TAGLINE: {
    en: 'The most secured decentralised NFT in cryptospace.',
    pt: '',
  },
  FOOTER_MENU_ONE_TITLE: {
    en: 'Secret Network',
    pt: '',
  },
  FOOTER_MENU_ONE_TAB_ONE: {
    en: 'Discover',
    pt: '',
  },
  FOOTER_MENU_ONE_TAB_TWO: {
    en: 'How to buy SCRT',
    pt: '',
  },
  FOOTER_MENU_ONE_TAB_THREE: {
    en: 'News & Updates',
    pt: '',
  },
  FOOTER_MENU_TWO_TITLE: {
    en: 'Support',
    pt: '',
  },
  FOOTER_MENU_TWO_TAB_ONE: {
    en: 'How it works',
    pt: '',
  },
  FOOTER_MENU_TWO_TAB_TWO: {
